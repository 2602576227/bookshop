                ...
                <ul>
                	...
                	<c:if test="${!empty user }">
	                    <li>
	                     ...
	                     <li>
	                        <a href="${pageContext.request.contextPath}/logout" style="color:rgb(241, 187, 10)">退出登陆</a>
	                    </li>
                	</c:if>
    ...
    <div class="estore_content" style="min-height: 800px;">
        <div class="header">
            ...
            <div class="estore" align="center">
                <h1 style="font-size:35px;text-align:center;padding-top:80px;color: #87520E;">Briup
                    <br/>图书商城
                </h1>
