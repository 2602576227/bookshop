$(function () {
    var e = {
        series: {bars: {show: !0, barWidth: .6, fill: !0, fillColor: {colors: [{opacity: .8}, {opacity: .8}]}}},
    ...
    {
        var e = [{label: "数据 1", data: 21, color: "#d3d3d3"}, {
            label: "数据 2",
            data: 3,
            color: "#bababa"
        }, {label: "数据 3", data: 15, color: "#79d2c0"}, {label: "数据 4", data: 52, color: "#1ab394"}];
    ...
    function e() {
        for (i.length && (i = i.slice(1)); i.length < t;) {
            var e = i.length ? i[i.length - 1] : 50, o = e + 10 * Math.random() - 5;
            i.push(0 > o ? 0 : o > 100 ? 100 : o)
        }
        for (var l = [], a = 0; a < i.length; ++a) l.push([a, i[a]]);
        return l
    }

    var o = $("#flot-line-chart-moving"), t = o.outerWidth() / 2 || 300, i = [];
    ...
    var l = $.plot(o, series, {
        grid: {
            ...
            markings: function (e) {
                for (var o = [], t = e.xaxis, i = Math.floor(t.min); i < t.max; i += 2 * t.tickSize) o.push({
                    xaxis: {
                        from: i,
                        to: i + t.tickSize
                    }, color: "#fff"
    ...
    setInterval(function () {
        series[0].data = e(), l.setData(series), l.draw()
    }, 40)
}), $(function () {
    function e(e, o) {
    ...
    function o(o) {
        $.plot($("#flot-line-chart-multi"), [{data: t, label: "油价 (&yen;)"}, {
            data: i,
            label: "美元/人民币汇率",
            yaxis: 2
        }], {
            ...
            legend: {position: "sw"},
            colors: ["#1ab394"],
            grid: {color: "#999999", hoverable: !0, clickable: !0, tickColor: "#D4D4D4", borderWidth: 0, hoverable: !0},
            tooltip: !0,
            tooltipOpts: {
